                    ...
                    <div class="author-info clearfix">
                        <div class="author-box pull-left">
                            @if ($property->agent_id == null)
                                <figure class="author-thumb"><img src="{{ url('upload/profile-pic.jpg') }}" alt="">
                                </figure>
                                <h6>Admin</h6>
                            @else
                ...
                <div class="right-column pull-right clearfix">
                    <div class="price-inner clearfix">
                        <ul class="category clearfix pull-left">
                            <li><a href="property-details.html">{{ $property->property_type->type_name }}</a></li>
                    ...
                    <div class="property-details-content">
                        ...
                        <div class="details-box content-widget">
                            ...
                            <ul class="list clearfix">
                                ...
                                <li>Property Type: <span>{{ $property->property_type->type_name }}</span></li>
                    ...
                    <div class="property-sidebar default-sidebar">
                        <div class="author-widget sidebar-widget">
                            <div class="author-box">
                                @if ($property->agent_id == null)
                                    <figure class="author-thumb"><img src="{{ url('upload/profile-pic.jpg') }}"
                                            alt=""></figure>
                                    <div class="inner">
                                        <h4>Admin </h4>
                                        <ul class="info clearfix">
                            ...
                            <div class="feature-block-one wow fadeInUp animated" data-wow-delay="00ms"
                                ...
                                <div class="inner-box">
                                    <div class="image-box">
                                        ...
                                        <span class="category">{{ $item->property_type->type_name }}</span>
                                    </div>
                                        ...
                                        <div class="author-info clearfix">
                                            <div class="author pull-left">
                                                @if ($item->agent_id == null)
                                                    <figure class="author-thumb"><img
                                                            src="{{ url('upload/profile_pic.jpg') }}" alt="">
                                                    </figure>
                                                    <h6>Admin </h6>
                                                @else
                                                    <figure class="author-thumb"><img
